...
2. Replaced the Phase 1 material in draft 14. The abstract, introduction,
   ...
   measurement, persona composition, topology, and D-net anchoring.
...
4. Applied the canonical 292 hatched-dead count. Older 290-cell text was not
   revived.
5. Kept T2c continuous and T2d dual-discrete MPR separate. The dual sidecar
   and absolute gap remain diagnostics.
6. Defined C5 as a table union. D-net remains a separately executed 63-node
   custom network.
7. Reported N=1, eight hops, `gpt-4o-mini`, 288 configurations, 1,728 cells,
   and D-net 4/4.
...
11. Consolidated bibliography keys from the reviewed literature draft and
    removed the unverified award note from the thesis bibliography.
12. Copied canonical figures into `thesis_final/figures/` and referenced each
    displayed figure before or as it appears in the results narrative.
