...
\texttt{user\_chemtrails\_hub} node has 33 unique neighbours.  The
conspiracy cut has modularity 0.4039 under mixed labels and 0.4566 when all
nodes are labelled conspiracy.  Mixed-label identity homophily is 0.8377
...
neighbours.  With the empirical discourse labels, the conspiracy-cut
modularity is \(Q=0.404\).  Identity edge homophily is \(0.873\);
...
node the same identity.  The corresponding conspiracy-cut modularities are
\(Q=0.404\) for mixed labels and \(Q=0.457\) under homogeneous labels.
