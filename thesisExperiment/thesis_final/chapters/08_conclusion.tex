...
propagate unchanged text, and failed audits remain unscored. Restricting the
analysis to zero-error runs reverses the small continuous He--H contrast
(\(-0.0295\) rather than \(+0.1549\)); the dual-discrete contrast remains
positive. Accordingly, the continuous collapsed-arm direction is not a robust
headline conclusion.
