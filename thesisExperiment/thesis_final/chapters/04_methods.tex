...
\begin{table}[tbp]
  ...
  \texttt{articles/merged.json}. Access date: 2026-09-19.}
...
\begin{table}[htbp]
  ...
  \label{tab:mm-c1-c5}
  \small
  \begin{tabular}{@{}p{0.07\textwidth}p{0.30\textwidth}p{0.23\textwidth}p{0.26\textwidth}@{}}
    \hline
