...
A public persistent archive, release tag, licence, and checksums were not
available at integration time. The present PDF therefore documents a
repository-relative, traceable harvest rather than a DOI-backed release.
\textbf{[ARCHIVE: insert repository URL, commit SHA, licence, and checksums
before submission.]} API credentials must not appear in configurations,
