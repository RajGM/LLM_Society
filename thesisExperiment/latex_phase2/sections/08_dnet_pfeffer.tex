...
Conspiracy-cut modularity is $Q=0.404$ on mixed labels and $Q=0.457$ if every node is labelled conspiracy.
...
clustering & \#3 network clusters & transitivity $0.315$; local $0.515$; $Q=0.404$ & same topology; $Q=0.404$ mixed, $0.457$ homo labels \\
