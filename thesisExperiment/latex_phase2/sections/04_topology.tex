...
\Cref{fig:topo} shows live-cell mean \texttt{meanMI} by topology and article across arms and modes.
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{figures/fig17_topology_article_mpr.png}
\caption[Topology $\times$ article \MPR{}]{Live-cell mean \texttt{meanMI} by topology and article, all arms and modes.
Discrete (T2d) and continuous (T2c) panels are not averaged.
$N=1$.
Source: \texttt{fig17\_topology\_article\_mpr.png}.}
\label{fig:topo}
\end{figure}
...
echo chamber & 61/72 & 1.7984 & 23.0\% & 15.3\% & 63/72 & 0.8490 & 12.3\% & 12.5\% \\
...
Echo-chamber H continuous is $0.8490$ ($n=63$ live).
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{figures/fig19_kstar_rates.png}
\caption[k-star rates]{Share of live cells with irreversible network \kstar{} (mean \MI{}$>3$ with no later recovery), by topology and scoring mode.
...
$N=1$.
Source: \texttt{fig19\_kstar\_rates.png}.}
\label{fig:kstar}
\end{figure}

\Cref{fig:dead} shows hatched dead-cell rates.
Overall, 292 of 1,728 thesis cells are hatched after LLM.
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{figures/fig18_dead_rates.png}
\caption[Hatched dead rates]{Hatched dead-cell rate by topology, arm, and scoring mode.
Dead means \texttt{nScored}$\le 1$ after real LLM calls.
Hatched cells are kept and are not scored as mix immunity.
$N=1$.
Source: \texttt{fig18\_dead\_rates.png}.}
\label{fig:dead}
\end{figure}
