...
%
% Figures: copies of thesisExperiment/analysis_full/figures/ (fig00--fig22).
% Comparison panels C1--C5 follow COMPARISONS.md.
%
...
\input{sections/03_instruments}
\input{sections/04_topology}
\input{sections/05_h_vs_he}
\input{sections/06_comparisons}
\input{sections/07_pooled}
\input{sections/08_dnet_pfeffer}
