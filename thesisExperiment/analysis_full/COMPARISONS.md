...
| scale_free | 0.9205 | 1.7034 | 0.7829 | 60 | 57 | 0.8463 |
| echo_chamber | 0.8490 | 1.7984 | 0.9494 | 63 | 61 | 0.8923 |
| polarized | 0.8356 | 1.7005 | 0.8649 | 65 | 57 | 0.8553 |
| hierarchical | 0.8751 | 1.6315 | 0.7564 | 52 | 59 | 0.7973 |

**2.1** Dual-discrete sits above continuous on **8/8** H topologies. Mean topology Δ(disc−cont) = **0.8201**.
...
**2.4** Dual gap on H live cells (discrete − sidecar continuous on the **same** dual events) = **0.8804**. That sidecar is not the T2c headline. Dual gap is not a third MPR.
**2.5** Exploratory Wilcoxon (8 topo means): W=0, p=0.007812, median Δ=0.8239, n=8 (n+=8, n-=0). Spearman rank of topology means: ρ=0.095, p=0.8225, n=8.
...
| scale_free | 0.9205 | 1.9924 | 1.0719 | 1.7034 | 0.8157 | -0.8877 |
| echo_chamber | 0.8490 | 1.9632 | 1.1141 | 1.7984 | 1.3775 | -0.4209 |
| polarized | 0.8356 | 1.8830 | 1.0474 | 1.7005 | 1.4137 | -0.2868 |
...
**4.2** Mean topology Δ(T2c_He − T2d_H) = **-0.6476**. Signs can reverse because the scoring-mode gap is large. That reversal is why C4 must stay unpooled.
...
| T2d_H_all_topologies | 478 | 1.6814 | 1.6839 | 20.1% |
...
| T2d_H_science_env_family | 193 | 0.8687 | 0.8660 | 0.0% |
...
**5.1 H vs He on the pooled cell set.** Same pattern as C1: He > H on both instruments (continuous Δ=0.1549; dual-discrete Δ=0.3986). Topology-equal weighting does not flip the sign (see table). Exploratory MW: T2c U=4.47e+04, p=1.314e-06, median_a=0.0413, median_b=0.5000, n=480/238; T2d U=4.56e+04, p=7.17e-06, median_a=1.1340, median_b=1.7500, n=478/240.
**5.2 Conspiracy-composition still holds on the pooled H cells.** T2c family meanMI: conspiracy **2.2194**, climate_action **0.1729**, science_env **0.1118**. T2d: conspiracy **3.1691**, climate_action **1.0488**, science_env **0.8687**. Conspiracy remains the high group on both instruments.
...
| biodiversity_food_security | science_env | 1.1470 | 0.2115 | 0.0% | 0.0% |
| ozone_stratosphere_specialist | science_env | 0.9639 | 0.1627 | 0.0% | 0.0% |
...
**P.3** Dual agreement (IFD-adjacent) H=0.6487, He=0.6174. Hop-wise MI, CR, MR, IR are **not in live tables** and were not invented.
