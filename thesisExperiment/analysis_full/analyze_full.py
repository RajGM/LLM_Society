...
Writes thesisExperiment/analysis_full/ (does not overwrite analysis/ or analysis_phase2/).

Hard rules
----------
* Source of MI/MPR/k*/dead/IFD-adjacent fields: results_phase2/tables/ only.
...
def write_markdown(key, c1, c2, c3, c4, pooled, pooled_meta, topo_df, persona_df, mix_df, family_df, article_df, dnet, harvest, compare, tests):
    ...
    readme = []
    readme.append("# Phase 2 full analysis (`analysis_full/`)")
    readme.append("")
    ...
    readme.append("")
    readme.append("Live tables only: `thesisExperiment/results_phase2/tables/`.")
    ...
    readme.append("")
    readme.append("```bash")
    readme.append("python3 thesisExperiment/analysis_full/analyze_full.py")
    readme.append("```")
    readme.append("")
