...
Generated: 2026-09-18T15:29:34.652Z
...
- Empirical file: `thesisExperiment/data/derived/debnath_hashtag_cascade.json` (generated fallback (reconstruct output not present))
- Empirical kind: `hashtag_cooccurrence`; generatedFallback=true
...
| --- | --- | --- | --- |
| depth | 3 | sim pending | longest path from root |
| breadth | 8 | sim pending | max nodes at one level |
| size | 18 | sim pending | informational only; real graphs are often larger |
| structuralVirality | 3.3399 | sim pending | Goel et al. 2016 pairwise distance |
...
| --- | --- | --- | --- | --- |
| valence | toxicity / hashtag proxy (not MPR) | 0.1067 (paper mean 0.17) | sim pending | measured_proxy |
| surprise | Pfeffer #1 speed/volume | paper SCoPEx spike quoted; not reconstructed | sim pending | held_drip |
| identity | Pfeffer #5 lack of diversity | conspiracy 0.3333 / other 0.6667 | sim pending | measured_hashtag_mix |
| clustering | Pfeffer #3 network clusters | n=18 meanDeg=1.8889 Q_conspiracy=0.4343 | sim pending | measured_hashtag_graph |
| echo | edge homophily | identityHomophily=0.7059 | sim pending | measured_edge_homophily |
